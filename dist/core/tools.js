...
import { DOWNLOAD_PAPER_TOOL, DOWNLOAD_WITH_FALLBACK_TOOL } from '../capabilities/pdf-discovery/tools.js';
import { GET_PAPER_BY_DOI_TOOL, SEARCH_PAPERS_TOOL } from '../capabilities/metadata-search/tools.js';
const BASE_TOOLS = [
    SEARCH_PAPERS_TOOL,
    {
        name: 'search_arxiv',
